...
# 開檔
f_orbit  = open("orbit.dat", "w")
f_orbit1 = open("orbit1.dat", "w")
f_sep    = open("separation.dat", "w")
f_vrel    = open("vrel.dat", "w")
...
for j in range(ji, je+1):
    ...
    # vrel.dat
    f_vrel.write("{:10.3f} {:10.6f} {:10.6f} {:10.6f}\n".format(t/yr, v*((M1+M2)/M1)/1e5, vax/1e5, vay/1e5))
